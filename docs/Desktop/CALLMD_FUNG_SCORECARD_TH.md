...
| **P4 — BYOM Phase 3 ให้จบ** | ทำ 8 งานที่เหลือของแผน: wire `cloud_config` commands, `policy.rs` 3-tier, `cloud_executor.rs`, spend guardrail, UI settings | เลือก local/cloud ต่อ task ได้จริง พร้อมเพดานค่าใช้จ่าย | `docs/superpowers/plans/2026-08-09-phase-3-byom-cloud-keys.md` |
