...
| 0.2.28b | 2026-09-17 | beta | Re-ran the approved local verification, recorded the sandbox-only Genesis lock denial and responsive host-level EXE, and kept packaged click-through/runtime gates open. | 1b1a763 | Codex |
| 0.2.29b | 2026-09-17 | beta | Confirmed host-level WiX MSI packaging succeeds with an isolated target; NSIS remains incomplete, and the MSI was not installed or executed. | 1b1a763 | Codex |
