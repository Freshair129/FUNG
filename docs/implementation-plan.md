...
| Source design | `docs/specs/2026-08-11-live-meeting-external-retrieval-design.md` |
...
|---|---|---|
| S1.1 | Home/Live active-surface entry selects `live-capture`; desktop bootstrap regression passes | Implemented |
...
| Version | Change |
|---|---|
| 0.1.9b | Reconciled the live-capture evidence wording from the historical microphone rail to the current Home/Live active-surface entry; implementation scope is unchanged. |
...
|---|---|---|---|---|---|
| 0.1.9b | 2026-09-20 | candidate | Reconciled live-capture evidence wording with the current Home/Live active-surface shell; implementation scope unchanged. | pending; docs reconciliation | RWANG |
